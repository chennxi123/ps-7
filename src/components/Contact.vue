<template>
  ...
  <footer class="px-3 max-w-sm md:max-w-md lg:max-w-xl mx-auto pt-10 pb-8">
    <form action="#" method="post" class="flex flex-col text-center text-lg">
      ...
      <input
        class="border-2 p-2 mt-4 rounded-lg"
        type="text"
        name="name"
        id="name"
        placeholder="Name"
      ...
      ></textarea>
      <button
        class="border-2 p-2 mt-4 rounded-lg max-w-max mx-auto"
        type="submit"
      >
        Get in Touch
      </button>
    <ul class="flex my-7 mx-auto gap-5">
      <li class="mr-2">
